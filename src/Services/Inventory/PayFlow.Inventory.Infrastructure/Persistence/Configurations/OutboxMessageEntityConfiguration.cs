    ...
    : IEntityTypeConfiguration<OutboxMessageEntity>
{
    public void Configure(EntityTypeBuilder<OutboxMessageEntity> builder)
    {
        ...
        builder.Property(message => message.OutboxMessageId).HasColumnName("outbox_message_id").ValueGeneratedNever();
        ...
        builder.Property(message => message.Destination).HasColumnName("destination").HasMaxLength(256).IsRequired();
        builder.Property(message => message.Producer).HasColumnName("producer").HasMaxLength(128).IsRequired();
        builder.Property(message => message.TraceParent).HasColumnName("trace_parent").HasMaxLength(256);
        ...
        builder.Property(message => message.PublishedAtUtc).HasColumnName("published_at_utc");
        builder.Property(message => message.AttemptCount).HasColumnName("attempt_count").HasDefaultValue(0).IsRequired();
        builder.Property(message => message.NextAttemptAtUtc).HasColumnName("next_attempt_at_utc");
        builder.Property(message => message.LastErrorCode).HasColumnName("last_error_code").HasMaxLength(128);
        ...
        builder.HasIndex(message => new { message.PublishedAtUtc, message.NextAttemptAtUtc, message.CreatedAtUtc })
