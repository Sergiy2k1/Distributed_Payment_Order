...
public static class BeginOrderProcessingKafkaMessageParser
{
    public const string Topic = "orders.commands";
    ...
    public static ConsumedBeginOrderProcessingMessage Parse(
        ...
        DateTimeOffset receivedAtUtc)
    {
        ...
        {
            throw new InvalidDataException(
                "Kafka payload is not valid BeginOrderProcessing.v1 JSON.",
                exception);
        }
    ...
    {
        var value =
            GetOptionalHeader(headers, name);
