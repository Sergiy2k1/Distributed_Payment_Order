...
public sealed class InventoryReservationRejectedInboxProcessor
{
    ...
    private readonly IInventoryReservationRejectedMessageHandler _handler;

    public InventoryReservationRejectedInboxProcessor(
        SagaDbContext dbContext,
        IInboxMessageRepository inboxRepository,
        IInventoryReservationRejectedMessageHandler handler)
    {
    ...
    public async Task<bool> ProcessAsync(
        ConsumedInventoryReservationRejectedMessage consumedMessage,
