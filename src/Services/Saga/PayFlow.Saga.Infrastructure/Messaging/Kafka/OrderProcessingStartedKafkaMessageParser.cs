...
public static class OrderProcessingStartedKafkaMessageParser
{
    ...
    public static ConsumedOrderProcessingStartedMessage Parse(
        ...
        DateTimeOffset receivedAtUtc)
    {
        ...
        {
            throw new InvalidDataException(
                "Kafka payload is not valid OrderProcessingStarted.v1 JSON.",
                exception);
        }
