...
public sealed class OrderCreatedInboxProcessor
{
    ...
    private readonly IOrderCreatedMessageHandler _handler;

    public OrderCreatedInboxProcessor(
        SagaDbContext dbContext,
        IInboxMessageRepository inboxRepository,
        IOrderCreatedMessageHandler handler)
    {
    ...
    public async Task<bool> ProcessAsync(
        ConsumedOrderCreatedMessage consumedMessage,
        ...
        var inserted =
            await _inboxRepository.TryInsertAsync(
                new InboxMessageEntity
                {
                    ...
                    SourceTopic =
                        consumedMessage.SourceTopic,
                    SourcePartition =
                        consumedMessage.SourcePartition,
                    SourceOffset =
                        consumedMessage.SourceOffset,
                    ReceivedAtUtc =
                        consumedMessage.ReceivedAtUtc,
                    ProcessedAtUtc = null
                },
