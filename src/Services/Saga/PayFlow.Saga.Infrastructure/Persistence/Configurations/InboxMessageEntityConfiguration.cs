    ...
    : IEntityTypeConfiguration<InboxMessageEntity>
{
    public void Configure(
        EntityTypeBuilder<InboxMessageEntity> builder)
    {
        builder.ToTable(
            "inbox_messages",
            table =>
        ...
        builder.Property(message => message.SourceTopic)
            .HasColumnName("source_topic")
            .HasMaxLength(256)
            .IsRequired();

        builder.Property(message => message.SourcePartition)
            .HasColumnName("source_partition")
            .IsRequired();

        builder.Property(message => message.SourceOffset)
